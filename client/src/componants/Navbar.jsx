  ...
  return (
    <aside className="navbar">
      <div className="toggle">
        {showMenu ? (
          <div className="toggle__menu" onClick={handleShowMenu}>
      ...
      <div className={showMenu ? "navbar__container show" : "navbar__container"}>
        <div className="navbar__container-list">
          <Link to="/" className={active == "" ? "navbar__container-list_item active" : "navbar__container-list_item"}>
            <div className='navbar__container-list_item-link'>
              <svg width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M9.4 25H16.6C22.6 25 25 22.6 25 16.6V9.4C25 3.4 22.6 1 16.6 1H9.4C3.4 1 1 3.4 1 9.4V16.6C1 22.6 3.4 25 9.4 25Z" stroke={active == "" ? "white" : "#9197B3"} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                <path d="M18.136 14.932C16.78 16.288 14.836 16.708 13.12 16.168L10.012 19.264C9.79598 19.492 9.35198 19.636 9.02798 19.588L7.58798 19.396C7.10798 19.336 6.67598 18.88 6.60398 18.412L6.41198 16.972C6.36398 16.66 6.51998 16.216 6.73598 15.988L9.83198 12.892C9.30398 11.176 9.71198 9.23203 11.068 7.87603C13.012 5.93203 16.18 5.93203 18.136 7.87603C20.08 9.80803 20.08 12.976 18.136 14.932Z" stroke={active == "" ? "white" : "#9197B3"} strokeWidth="2" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round" />
                <path d="M11.14 18.136L10.1199 17.104" stroke={active == "" ? "white" : "#9197B3"} strokeWidth="2" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round" />
                <path d="M14.6734 11.44H14.684" stroke={active == "" ? "white" : "#9197B3"} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
              </svg>
              <h3>Dashboard</h3>
            </div>
            <i className='bx bx-chevron-right bx-sm' />
          </Link>
          <Link to="/equipements" className={active == "equipments" ? "navbar__container-list_item active" : "navbar__container-list_item"}>
            <div className='navbar__container-list_item-link'>
              <svg width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <Link to="/calendrier" className={active == "calendar" ? "navbar__container-list_item active" : "navbar__container-list_item"}>
            <div className='navbar__container-list_item-link'>
          ...
          <Link to="/utilisateurs" className={active == "user" ? "navbar__container-list_item active" : "navbar__container-list_item"}>
            <div className='navbar__container-list_item-link'>
              <svg width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
